...
export const ALL_TEAM_MEMBERS: TeamMember[] = [
  // Executive Leads
  {
    ...
    year: '4th Year',
    interestingFact: 'Has 3D-printed over 40 custom drone frames and once rewired an autonomous rover chassis at 3 AM using only a paperclip and zip-ties.',
    image: ''
  },
  {
    ...
    year: '3rd Year',
    interestingFact: "Manages YEC's six-figure competition budget through color-coded pivot tables and is an artisanal espresso bean roaster.",
    image: ''
  },
  {
    ...
    year: '3rd Year',
    interestingFact: 'Pitched YEC to 20+ engineering firms during a surprise blizzard transit delay and locked in three premier category sponsors.',
    image: ''
  },
  {
    name: 'Tehreem Asad',
    ...
    year: '4th Year',
    interestingFact: 'Types at an Olympic 135 WPM and programmed an automated dispatch script to coordinate volunteer check-ins across all 7 venues.',
    image: ''
  },
  {
    name: 'Allen Abraham',
    ...
    year: '3rd Year',
    interestingFact: 'Memorized the architectural blueprints of the entire Bergeron Centre, including the exact location of every single AC circuit breaker.',
    image: ''
  },
  {
    ...
    year: '3rd Year',
    interestingFact: 'Designed the official YEC mascot stickers and collects rare mid-century Swiss engineering drafting tools and typography specimen books.',
    image: ''
  },
  {
    ...
    year: '4th Year',
    interestingFact: 'Built a custom home Kubernetes cluster using decommissioned blade servers and drinks a double espresso for every production deploy.',
    image: ''
  },
  {
    ...
    major: 'Mechanical Engineering',
    year: '4th Year',
    interestingFact: 'Led a high-altitude meteorological weather balloon launch that successfully gathered atmospheric telemetry data from 92,000 feet.',
    image: ''
  },
  {
    name: 'Ziad Hammouda',
    ...
    year: '2nd Year',
    interestingFact: 'Built an amateur satellite ground station antenna in his backyard that actively decodes live weather imagery from NOAA satellites.',
    image: ''
  },
  // Competition Leads
  {
    name: 'Maheen Mirza',
    role: 'Competition Lead (Junior Design)',
    category: 'Competition Lead',
    major: 'Mechatronics Engineering',
    year: '3rd Year',
    interestingFact: 'Won 1st place in Junior Design as a freshman and can solder ultra-fine 0402 surface-mount components by hand without a microscope.',
    image: ''
  },
  {
    name: 'Hadia Ali',
    role: 'Competition Lead (Senior Design)',
    category: 'Competition Lead',
    major: 'Mechanical Engineering',
    year: '4th Year',
    interestingFact: 'Fully rebuilt a vintage two-stroke motorcycle carburetor and powertrain over the summer and rode it across southern Ontario.',
    image: ''
  },
  {
    name: 'Hiam Al-Jamal',
    role: 'Competition Lead (Consulting)',
    category: 'Competition Lead',
    major: 'Civil & Environmental Engineering',
    year: '3rd Year',
    interestingFact: 'Formulated an urban sustainable stormwater bioswale proposal that was formally reviewed by municipal infrastructure advisors.',
    image: ''
  },
  {
    name: 'Ibrahim Rfifi',
    role: 'Competition Lead (Innovative Design)',
    category: 'Competition Lead',
    major: 'Software Engineering',
    year: '3rd Year',
    interestingFact: 'Filed a provisional patent for a low-latency haptic sensory glove engineered to assist visually impaired engineering students in physics labs.',
    image: ''
  },
  {
    name: 'Kenzi',
    role: 'Competition Lead (Re-Engineering)',
    category: 'Competition Lead',
    major: 'Materials Engineering & Applied Physics',
    year: '3rd Year',
    interestingFact: 'Can identify metal alloy grades by evaluating grind-wheel spark trails and has restored over a dozen vintage analog audio synthesizers.',
    image: ''
  },
  {
    name: 'Luna Marouf',
    role: 'Competition Lead (Communications & Debate)',
    category: 'Competition Lead',
    major: 'Space Engineering',
    year: '4th Year',
    interestingFact: 'Former national parliamentary debate finalist who once delivered an impromptu 10-minute speech on orbital Lagrange points with zero notes.',
    image: ''
  }
];

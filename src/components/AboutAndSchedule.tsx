    ...
    <section id="about-yec" className="relative bg-[#f6f7f9] text-[#121620] py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div id="schedule-section" className="pt-6 sm:pt-8 mb-12">
          ...
          <div className="relative flex flex-col md:flex-row items-center md:items-end justify-between gap-4 sm:gap-6 border-[4px] sm:border-[6px] border-black bg-[#ff9900]/15 px-5 sm:px-8 pt-4 sm:pt-5 pb-0 rounded-lg mb-8 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]">
